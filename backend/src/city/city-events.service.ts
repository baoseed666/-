...
const SEED_EVENTS = [
  {
    ...
    bookingUrl: 'https://www.dianping.com/activity/longhua_miaohui',
    tags: ['传统', '非遗', '亲子', '免费入场'],
    costLow: 0,
    costHigh: 100,
  },
  ...
  },
  {
    ...
    bookingUrl: 'https://www.dianping.com/activity/xian_coffee',
    tags: ['咖啡', '户外', '打卡', '五一'],
    costLow: 30,
    costHigh: 200,
  },
  {
    ...
    discounts: { 促销: '早鸟票9折' },
    bookingUrl: 'https://www.dianping.com/shop/sh_lh_036',
    tags: ['演出', '户外', '周末', '早鸟'],
    costLow: 80,
    costHigh: 300,
  },
  {
    ...
    venue: '西岸梦中心',
    neighborhood: '西岸梦中心',
    startDate: new Date('2026-04-17T20:00:00'),
    endDate: new Date('2026-12-31T02:00:00'),
    description: '每周五六日舞托邦主题夜，工作日7折特惠',
    discounts: { 促销: '工作日7折' },
    bookingUrl: 'https://www.dianping.com/shop/sh_lh_034',
    tags: ['夜生活', '沉浸', '周末', '工作日优惠'],
    costLow: 100,
    costHigh: 280,
  },
  {
    ...
    discounts: { 特色: '免费' },
    bookingUrl: 'https://www.dianping.com/shop/sh_lh_038',
    tags: ['免费', '运动', '社群', '周末早晨'],
    costLow: 0,
    costHigh: 0,
  },
  {
    ...
    discounts: { 特色: '免费' },
    bookingUrl: 'https://www.dianping.com/shop/sh_lh_037',
    tags: ['免费', '瑜伽', '周末', '健康'],
    costLow: 0,
    costHigh: 0,
  },
  {
    ...
    bookingUrl: 'https://www.dianping.com/shop/sh_lh_046',
  ...
  },
  {
    ...
    discounts: { 特惠: '特惠品种限量' },
    bookingUrl: 'https://www.meituan.com/meishi/sh_lh_010',
    tags: ['早市', '限量', '每日', '超市特惠'],
    costLow: 20,
    costHigh: 100,
  },
...
export class CityEventsService implements OnApplicationBootstrap {
  ...
  async onApplicationBootstrap(): Promise<void> {
    ...
    if (count > 0) return;
    this.logger.log('Seeding city events...');
