...
- Name: challenge.spec.ts >> 挑战正常流程（带位置） >> 完整链路：创建→城市脉冲→AI生成→完成任务→生成战报
- Location: e2e\challenge.spec.ts:124:3
...
Call log:
  - waiting for locator('.task-badge-main') to be visible
...
- generic [ref=e3]:
  ...
  - generic [ref=e36]:
    - paragraph [ref=e37]: ⚡ 正在搜索「烧烤烤肉」省钱方案...
    - paragraph [ref=e38]: 2986 字符已接收
```
