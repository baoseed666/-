...
- Name: challenge.spec.ts >> 挑战正常流程（带位置） >> ShopCard包含店铺名称、地址+距离、优惠标签
- Location: e2e\challenge.spec.ts:85:3
...
- generic [ref=e3]:
  ...
  - generic [ref=e36]:
    - generic [ref=e38]:
      ...
      - paragraph [ref=e42]: 在ALDI特惠早市关闭前（假设早市持续到下午），快速采购限量特惠食材如蔬菜或调料，自带至火锅店，减少点菜开销。
    - generic [ref=e44]:
      - generic [ref=e45]:
        - generic [ref=e46]: ⚡ 支线任务
        - button "✓ 完成" [ref=e47] [cursor=pointer]
      - paragraph [ref=e48]: 在去火锅店前，顺路参观朵云轩的免费展览，利用学生证享受5折优惠（如果适用），丰富下午活动而不增加预算。
      - list [ref=e49]:
        - listitem [ref=e50]:
          - generic [ref=e51]: ›
          - text: 朵云轩部分免费展览可节省娱乐费用
        - listitem [ref=e52]:
          - generic [ref=e53]: ›
          - text: 学生证折扣进一步省钱
    - generic [ref=e55]:
      ...
      - paragraph [ref=e59]: 在下午时段错峰消费，利用美团/大众点评等平台搜索徐汇区龙华街道附近的火锅店，寻找新用户首单优惠或拼单团购套餐。选择人均约30-40元的套餐，例如小火锅或自助火锅，叠加平台优惠券和满减活动。注意查看店铺评价，确保性价比。
      - list [ref=e60]:
        - listitem [ref=e61]:
          - generic [ref=e62]: ›
          - text: 错峰消费（如下午2-4点）可享受更低折扣
        - listitem [ref=e63]:
          - generic [ref=e64]: ›
          - text: 3人拼单使用新用户首单优惠，每人可省10-20元
        - listitem [ref=e65]:
          - generic [ref=e66]: ›
          - text: 自带饮料或小食减少额外开销
