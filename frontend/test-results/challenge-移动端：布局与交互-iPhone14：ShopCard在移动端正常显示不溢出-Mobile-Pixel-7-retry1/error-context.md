...
- generic [ref=e3]:
  ...
  - generic [ref=e36]:
    - generic [ref=e38]:
      ...
      - paragraph [ref=e42]: 隐藏成就：完成拼单购买，与朋友分摊食材费用，进一步压缩成本。
    - generic [ref=e44]:
      - generic [ref=e45]:
        - generic [ref=e46]: ⚡ 支线任务
        - button "✓ 完成" [ref=e47] [cursor=pointer]
      - paragraph [ref=e48]: 支线任务：参观朵云轩当期展览，享受免费或学生折扣。
      - list [ref=e49]:
        - listitem [ref=e50]:
          - generic [ref=e51]: ›
          - text: 利用展览免费部分省钱，或使用学生证获取5折优惠
    - generic [ref=e53]:
      - generic [ref=e54]:
        - generic [ref=e55]: 🎯 主线任务
        - button "✓ 完成" [ref=e56] [cursor=pointer]
      - paragraph [ref=e57]: 主线任务：利用ALDI特惠早市购买火锅食材，自制火锅。原因：用户提议火锅，但100元预算在徐汇区龙华街道很难覆盖2人堂食，自制可大幅省钱。
      - list [ref=e58]:
        - listitem [ref=e59]:
          - generic [ref=e60]: ›
          - text: 前往龙华会ALDI特惠早市，购买特惠限量食材如蔬菜、肉类，错峰消费以避开人流高峰
        - listitem [ref=e61]:
          - generic [ref=e62]: ›
          - text: 自带锅具和调味料，避免额外购买
      - generic [ref=e63]: 💡 位置未知或该城市暂无店铺数据，请手动搜索
  - button "🏆 完成挑战，生成战报" [ref=e65] [cursor=pointer]
```
